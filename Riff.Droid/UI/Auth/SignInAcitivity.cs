...
namespace Riff.Droid.UI.Auth
{
    [Activity(Label = "Sign in to OneDrive", Name = "com.riff.droid.SignInActivity", LaunchMode = Android.Content.PM.LaunchMode.SingleTop)]
    public class SignInAcitivity : Activity
    {
        private IRiffApp appContext = null;
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            this.appContext = ApplicationContext as IRiffApp;
