...
namespace Riff.UWP.ViewModel.Commands
{
    ...
    public sealed class AddArtistToPlaylistCommand : AsyncCommand<ArtistItemViewModel>
    {
        private readonly IMusicLibrary library;
        private readonly PlaylistsViewModel playlistsVM;

        public AddArtistToPlaylistCommand(IMusicLibrary library, PlaylistsViewModel playlistsVM)
        {
            this.library = library;
            this.playlistsVM = playlistsVM;
        }
        ...
        protected override async Task RunAsync(ArtistItemViewModel artist)
        {
            ...
            if (result == Windows.UI.Xaml.Controls.ContentDialogResult.Primary)
            {
                ...
                await playlistsVM.AddToPlaylist(artist.Item, playlist);
            }
        }
    }
}
